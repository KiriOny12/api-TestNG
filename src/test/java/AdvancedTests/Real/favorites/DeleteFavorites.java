...
public class DeleteFavorites  {
    ...
    public void deleteFavorites(String labelUrl, String email, String password, String rememberMeEmpty, String urlOfAuthRequester, String sourcePlatform, int indexForAssetId) throws IOException {
        ...
        String route = "favorites/"+getAssets.firstAssetId;
